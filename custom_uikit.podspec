...
Pod::Spec.new do |s|
  s.name             = 'custom_uikit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of custom_uikit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/duzhe/custom_uikit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'duzhe' => '363958265@qq.com' }
  s.source           = { :git => 'https://github.com/duzhe/custom_uikit.git', :tag => s.version.to_s }
